        ...
        <div className="space-y-24">
          {projects.map((project) => (
            <article key={project.id} className="relative px-6">
              ...
              <h2 
                className="font-display text-[22vw] leading-[0.88] tracking-[-0.05em] font-bold text-foreground relative z-10 -mb-[8vw]"
      ...
      >
        {projects.map((project, index) => (
          ...
          >
            ...
            >
              <h2 
                className="font-display text-[18vw] md:text-[16vw] lg:text-[14vw] leading-[0.88] tracking-[-0.05em] font-bold text-foreground"
                style={{ fontVariationSettings: "'wdth' 80, 'opsz' 96" }}
              >
                {project.name}
              </h2>
