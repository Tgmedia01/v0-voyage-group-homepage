  ...
  return (
    <>
      <header className="fixed top-0 left-0 right-0 z-50 pointer-events-none">
        {/* Subtle gradient backdrop so text stays readable over any section */}
        ...
        <div className="relative flex items-center justify-between px-6 py-6 md:px-8 md:py-8">
          ...
          <a 
            href="#" 
            className="font-display text-lg md:text-xl tracking-[-0.04em] text-foreground font-bold pointer-events-auto"
              ...
              {menuLinks.map((link, index) => (
                ...
                >
                  ...
                  >
                    ...
                    {/* Link text */}
                    <span 
                      className="font-display text-[18vw] md:text-[13vw] leading-[1] tracking-[-0.05em] font-bold text-foreground"
